...
const UpdateExpense = ({ params }) => {
    ...
    const initialValues = {
        ...params,
        expense_date: new Date(params.expense_date)
    };

    const getExpense = async () => {
        try {
            // console.log("aqui", params.user_id);
            const res = await axiosServer.get(`getExpense/${params.id}`);
    ...
    return (
        <Layout>
            <ContentStyled>
                <CardCreateStyled>
                    <TitleStyled>Atualizar Despesa</TitleStyled>
                        ...
                        {({
                            ...
                            return (
                                ...
                                <FormStyled>
                                    ...
                                    <ContainerGroupStyled gridArea="C0">
                                    ...
                                    <ContainerGroupStyled gridArea="BT">
                                        <ButtonStyled type="submit">Atulizar Despesa</ButtonStyled>
                                    </ContainerGroupStyled>
                                </FormStyled>
                            )
                        }}
